...
'''
A script based on https://github.com/qutebrowser/qutebrowser/blob/master/qutebrowser/__init__.py
'''

# NOTE: should maybe use https://stackoverflow.com/questions/1523427/what-is-the-common-header-format-of-python-files
